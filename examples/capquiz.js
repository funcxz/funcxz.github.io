...
var _user$project$Main$list = function (items) {
	var f = function (it) {
		var _p0 = it;
		switch (_p0.ctor) {
			case 'Right':
	...
	return A2(
		...
		A2(
			...
			A2(_elm_lang$core$List$map, f, items)));
};
var _user$project$Main$status = function (st) {
	var _p3 = function () {
		var _p4 = st;
		switch (_p4.ctor) {
			case 'Right':
				return {
					ctor: '_Tuple2',
					_0: 'green',
					_1: A2(_elm_lang$core$Basics_ops['++'], 'Right. ', _p4._0)
				};
			case 'Wrong':
				return {
					ctor: '_Tuple2',
					_0: 'red',
					_1: A2(_elm_lang$core$Basics_ops['++'], 'Wrong! ', _p4._0)
				};
			default:
...
var _user$project$Main$score = function (stats) {
	var winsFun = function (it) {
		var _p5 = it;
		switch (_p5.ctor) {
			case 'Right':
				return true;
	...
	var wins = _elm_lang$core$List$length(
		A2(_elm_lang$core$List$filter, winsFun, stats));
	var losts = _elm_lang$core$List$length(stats) - wins;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(wins),
						A2(
							_elm_lang$core$Basics_ops['++'],
							':',
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(losts),
								')')))))
			]));
};
var _user$project$Main$Quiz = F2(
	function (a, b) {
		return {country: a, capital: b};
	});
var _user$project$Main$decode = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$Main$Quiz,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'Country', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'Capital', _elm_lang$core$Json_Decode$string));
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {quiz: a, answer: b, statistics: c, status: d, mdl: e};
	});
...
var _user$project$Main$getNewQuiz = A3(
	_elm_lang$core$Task$perform,
	_user$project$Main$FetchFail,
	_user$project$Main$FetchSucceed,
	A2(_evancz$elm_http$Http$get, _user$project$Main$decode, 'https://funcxz.azurewebsites.net/api/capitalsquiz'));
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									{ctor: '_Tuple2', _0: 'color', _1: 'CadetBlue '}
								]))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Capitals & Countries <| quiz')
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$Main$score(model.statistics),
							_elm_lang$html$Html$text(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'What is the capital of ',
								A2(_elm_lang$core$Basics_ops['++'], model.quiz.country, ': '))),
							A4(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_debois$elm_mdl$Material_Textfield$label('the answer'),
									_debois$elm_mdl$Material_Textfield$onInput(_user$project$Main$Answer),
									_debois$elm_mdl$Material_Textfield$value(model.answer),
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_debois$elm_mdl$Material_Button$onClick(_user$project$Main$Check),
					...
					_user$project$Main$status(model.status),
					_user$project$Main$list(model.statistics),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(model.quiz.capital)
						]))
				])));
};
var _user$project$Main$Wrong = function (a) {
		...
		switch (_p6.ctor) {
			case 'Answer':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{answer: _p6._0, status: _user$project$Main$None}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'Check':
				var message = A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						model.quiz.country,
						A2(_elm_lang$core$Basics_ops['++'], ' is ', model.quiz.capital)));
				var checkStatus = _elm_lang$core$Native_Utils.eq(
					_elm_lang$core$String$toUpper(model.answer),
					_elm_lang$core$String$toUpper(model.quiz.capital)) ? _user$project$Main$Right(message) : _user$project$Main$Wrong(message);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							statistics: A2(_elm_lang$core$List_ops['::'], checkStatus, model.statistics),
							status: checkStatus
						}),
					_elm_lang$core$Native_List.fromArray(
						[_user$project$Main$getNewQuiz]));
			case 'FetchSucceed':
				var _p7 = _p6._0;
				return _elm_lang$core$Native_Utils.eq(_p7.capital, '') ? A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					_elm_lang$core$Native_List.fromArray(
						[_user$project$Main$getNewQuiz])) : A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{quiz: _p7, answer: ''}),
...
var _user$project$Main$model = {
	quiz: A2(_user$project$Main$Quiz, '', ''),
	answer: '',
	statistics: _elm_lang$core$Native_List.fromArray(
		[]),
	mdl: _debois$elm_mdl$Material$model,
	status: _user$project$Main$None
};
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$Main$model, _1: _user$project$Main$getNewQuiz},
